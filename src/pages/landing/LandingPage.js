            ...
            <Box sx={{height: 'calc(100vh - 64px)', display: 'flex', padding: '100px'}} >
                <Box sx={{width: '50%', height: '100%', display: 'grid', justifyContent: 'center', alignItems: 'center', padding: '8px'}}>
                    <div>
                        ...
                        <Button variant='contained' endIcon={<RiArrowRightLine fontSize={'20px'}/>} style={{textTransform: 'none', borderRadius: '30px', padding: '10px 30px', fontSize: '1.15rem', fontWeight: '300'}} >Get Started</Button>
                    </div>
                </Box>
                <Box sx={{width: '50%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0px'}}>
                    <Box component={'img'} src={SignupImage} width={'100%'} height={'100%'} sx={{objectFit: 'contain'}}/>
                </Box>
            </Box>
        </Box>
    </div>
